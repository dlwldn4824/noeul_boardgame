...
export const BOARD_CELLS: BoardCell[] = [
  ...
  { id: 1, name: '보컬 원샷', type: 'oneshot', x: 20.8, y: 88.5 },
  ...
  { id: 6, name: '기타 원샷', type: 'guitar', x: 79.7, y: 88.5 },
  { id: 7, name: '운영진 쿠폰', type: 'coupon', x: 92.9, y: 88.5 },
  ...
  { id: 11, name: '두 칸 뒤로', type: 'move', x: 92.9, y: 27.9 },
  ...
  { id: 17, name: '운영진 쿠폰', type: 'coupon', x: 32.4, y: 9.2 },
  { id: 18, name: '우즈 80점', type: 'game', x: 21.2, y: 9.2 },
  ...
  { id: 26, name: '소주1잔', type: 'normal', x: 62.5, y: 55.2 },
